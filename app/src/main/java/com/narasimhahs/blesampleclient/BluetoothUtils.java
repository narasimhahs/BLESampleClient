...
import static com.narasimhahs.blesampleclient.Constants.CHARACTERISTIC_ECHO_STRING;
import static com.narasimhahs.blesampleclient.Constants.CHARACTERISTIC_LED_BALLAST_STRING;
import static com.narasimhahs.blesampleclient.Constants.CHARACTERISTIC_TIME_STRING;
import static com.narasimhahs.blesampleclient.Constants.CLIENT_CONFIGURATION_DESCRIPTOR_SHORT_ID;
import static com.narasimhahs.blesampleclient.Constants.LED_SERVICE_STRING;
import static com.narasimhahs.blesampleclient.Constants.SERVICE_STRING;

public class BluetoothUtils {
    // Characteristics
    static List<BluetoothGattCharacteristic> findCharacteristics(BluetoothGatt bluetoothGatt) {
    ...
    @Nullable
    static BluetoothGattCharacteristic findEchoCharacteristic(BluetoothGatt bluetoothGatt) {
    ...
    @Nullable
    public static BluetoothGattCharacteristic findLedCharacteristic(BluetoothGatt bluetoothGatt) {
        return findCharacteristic(bluetoothGatt, CHARACTERISTIC_LED_BALLAST_STRING);
    }
    ...
    static boolean isEchoCharacteristic(BluetoothGattCharacteristic characteristic) {
    ...
    private static boolean matchesCharacteristicUuidString(String characteristicIdString) {
        return uuidMatches(characteristicIdString, CHARACTERISTIC_ECHO_STRING, CHARACTERISTIC_TIME_STRING, CHARACTERISTIC_LED_BALLAST_STRING);
    }

    static boolean requiresResponse(BluetoothGattCharacteristic characteristic) {
        return (characteristic.getProperties() & BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE)
                != BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE;
    }

    static boolean requiresConfirmation(BluetoothGattCharacteristic characteristic) {
    ...
    // Descriptor
    @Nullable
    static BluetoothGattDescriptor findClientConfigurationDescriptor(List<BluetoothGattDescriptor> descriptorList) {
    ...
    private static boolean matchesServiceUuidString(String serviceIdString) {
        return uuidMatches(serviceIdString, SERVICE_STRING, LED_SERVICE_STRING);
    }
